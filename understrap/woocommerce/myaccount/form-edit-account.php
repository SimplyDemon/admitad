...
<form class="woocommerce-EditAccountForm edit-account" action=""
    ...
    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        <label for="account_display_name"><?php esc_html_e( 'Display name', 'understrap' ); ?>&nbsp;<span
                    class="required">*</span></label>
        ...
        <span><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'understrap' ); ?></em></span>
    </p>
    <div class="clear"></div>
